  ...
  return (
    <section className="px-8 md:px-24">
      <div className="grid gap-y-3 justify-center items-center">
        ...
        <div className="grid md:grid-flow-col md:gap-x-6 mt-8 grid-flow-row gap-y-2">
          <div className="border border-s border-[#052115] rounded-lg">
            <div className="flex gap-x-15 justify-between p-4">
              <div className="grid gap-y-3">
                ...
                <p className="text-sm text-primary">Assets under management.</p>
              </div>
          ...
          <div className="border border-s border-[#052115] rounded-lg">
            <div className="flex gap-x-15 justify-between p-4">
              <div className="grid gap-y-3 ">
                ...
                <span className="flex gap-x-1">
                  <img src="/burn.png" className="w-6 h-6" alt="burn.png"></img>
